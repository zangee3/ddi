 ...
 * @ignore
 */
var initialContext = __assign(__assign({}, initialAuthState), { buildAuthorizeUrl: stub, buildLogoutUrl: stub, getAccessTokenSilently: stub, getAccessTokenWithPopup: stub, getIdTokenClaims: stub, loginWithRedirect: stub, loginWithPopup: stub, logout: stub });
/**
 * The Auth0 Context
 */
...
var hasAuthParams = function (searchParams) {
    ...
    return (CODE_RE.test(searchParams) && STATE_RE.test(searchParams)) ||
...
var Auth0Provider = function (opts) {
    var _a;
    var children = opts.children, skipRedirectCallback = opts.skipRedirectCallback, _b = opts.onRedirectCallback, onRedirectCallback = _b === void 0 ? defaultOnRedirectCallback : _b, clientOpts = __rest(opts, ["children", "skipRedirectCallback", "onRedirectCallback"]);
    var client = useState(function () { return new Vo(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    var userUpdatedAt = (_a = state.user) === null || _a === void 0 ? void 0 : _a.updated_at;
    var getAccessTokenSilently = useCallback(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3: return [4 /*yield*/, client.getUser()];
                case 4:
                    user = _a.sent();
                    if ((user === null || user === void 0 ? void 0 : user.updated_at) !== userUpdatedAt) {
 ...
 */
var useAuth0 = function () { return useContext(Auth0Context); };
...
var withAuthenticationRequired = function (Component, options) {
    ...
    return function WithAuthenticationRequired(props) {
        var _this = this;
        var _a = useAuth0(), isAuthenticated = _a.isAuthenticated, isLoading = _a.isLoading, loginWithRedirect = _a.loginWithRedirect;
        var _b = options.returnTo, returnTo = _b === void 0 ? defaultReturnTo : _b, _c = options.onRedirecting, onRedirecting = _c === void 0 ? defaultOnRedirecting : _c, _d = options.loginOptions, loginOptions = _d === void 0 ? {} : _d;
        useEffect(function () {
...
export { Auth0Context, Auth0Provider, OAuthError, useAuth0, withAuth0, withAuthenticationRequired };
