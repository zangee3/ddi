...
var getMissingScope = function (originalScope, comparingScope) {
    if (originalScope === void 0) { originalScope = ''; }
    if (comparingScope === void 0) { comparingScope = ''; }
    var originalScopes = originalScope.split(/\s+/);
    var comparingScopes = comparingScope.split(/\s+/);
    return originalScopes
        .filter(function (scope) { return !comparingScopes.includes(scope); })
        .join(' ');
};
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (missingScope.length) {
                        console.warn("The requested scopes (" + scope + ") are different from the scopes of the retrieved token (" + result.scope + "). This could mean that your access token may not include all the scopes that you expect. It is advised to resolve this by either:\n  \n  - Removing `" + missingScope + "` from the scope when requesting a new token.\n  - Ensuring `" + missingScope + "` is returned as part of the requested token's scopes.");
                    }
...
var CacheKey = /** @class */ (function () {
    function CacheKey(data, prefix) {
        if (prefix === void 0) { prefix = keyPrefix; }
        this.prefix = prefix;
...
var findExistingCacheKey = function (cacheKey, existingCacheKeys) {
    ...
    return existingCacheKeys.filter(function (key) {
        ...
        var hasAllScopes = currentScopes &&
            scope
                .split(' ')
                .reduce(function (acc, current) { return acc && currentScopesArr.includes(current); }, true);
        return (currentPrefix === keyPrefix &&
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 10: throw new TimeoutError();
